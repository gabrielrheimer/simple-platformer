...
var referenceCanvas = document.getElementById("reference"), ctx = referenceCanvas.getContext("2d"), width = 1000, height = 400, player = {
    x: width / 2,
    y: 200,
    width: 25,
    height: 25,
    ...
    grounded: false,
    color: '#E6AC27'
}, keys = [], friction = 0.8, gravity = 0.4, boxes = [], powerup = [];
powerup.push({
    x: 810,
    y: 250,
    width: 20,
